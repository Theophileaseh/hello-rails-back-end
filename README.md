...
> An API enpoint built using Ruby on Rails as backend.

## [Link To React App](https://github.com/Theophileaseh/hello-react-front-end/)
...
### Install
    ...
    git clone https://github.com/Theophileaseh/hello-rails-back-end.git
